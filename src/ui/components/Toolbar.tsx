...
export function Toolbar() {
  ...
  // Render popups using React Portals to break out of the backdrop-blur trapping container
  ...
  const popupClasses =
    'fixed bottom-24 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-3xl border border-black/10 rounded-3xl shadow-[0_24px_50px_rgba(0,0,0,0.15)] p-5 z-[500] animate-in zoom-in-95 duration-200 cursor-default';
